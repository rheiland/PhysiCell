...
out_dir = "./output_monolayer_pressure_set_behavior_live"
out_dir = "./output_monolayer_flowcytsep_fixed"
out_dir = "./output_monolayer_pressure_p2_5_live_fix_exit_rate"
out_dir = "./output_monolayer_flowcytsep_fixed_rules2"
# out_dir = "./output_monolayer_pressure_set_behavior_live_p6"
# out_dir = "./output_monolayer_pressure_set_behavior_live_p12"
...
for idx in range(0,max_frame+1, hr_delta):
    ...
    print(f'{idx}) t(min)={current_time}, hr={current_time/60.}, diam={diam}, # cells={cells_x.shape[0]}')
...
if add_points_flag:
#   for idx in [336, 386, 408, 481, 506, 646]:   # times (hours) from the table (original)
...
#   for idx in [84, 96, 102, 120, 126, 153]:   # approx if save interval =4 hrs
  for idx in [28,33,34,41,42,54]:   # save interval =720 mins; plus custom saves
    xml_file = "output%08d.xml" % idx
